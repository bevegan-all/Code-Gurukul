  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 relative">
      ...
      <div className="p-8 max-w-6xl mx-auto w-full flex-1">
        ...
        {loading ? (
          <div className="flex justify-center p-12" role="status" aria-label="Loading subjects">
          ...
          >
            {subjects.map(s => (
              <div 
                ...
                role="link"
                tabIndex={0}
                aria-label={`Subject: ${s.subject_name}, taught by Prof. ${s.teacher_name}, type: ${s.type}. Press Enter to open.`}
                ...
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); navigate(`/app/learn/${s.subject_id}`); } }}
              >
                <div className="p-3 bg-indigo-50 w-max rounded-xl text-indigo-600 mb-4 group-hover:scale-110 transition-transform" aria-hidden="true">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-500 mb-6">
                  <Users size={16} aria-hidden="true" /> Prof. {s.teacher_name}
                </div>
                ...
                <div className="mt-auto flex justify-between items-center border-t border-slate-100 pt-4">
                  ...
                  <ArrowRight size={20} className="text-slate-400 group-hover:text-indigo-600 transform group-hover:translate-x-1 transition-all" aria-hidden="true" />
                </div>
              </div>
            ))}
          </div>
