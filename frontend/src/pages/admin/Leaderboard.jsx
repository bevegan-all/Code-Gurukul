  ...
  return (
    <div className="p-6 max-w-4xl mx-auto w-full space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-500 mt-1 font-medium">All students ranked by combined assignment + quiz marks</p>
      </div>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        {classes.length > 0 && (
          <select
            ...
            className="px-4 py-2.5 border border-slate-200 rounded-xl text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-300 bg-white"
          >
            ...
            {filtered.map((entry, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-11 h-11 rounded-full bg-gradient-to-tr from-indigo-200 to-blue-100 flex items-center justify-center font-bold text-indigo-700 shadow-inner text-lg flex-shrink-0">
                ...
                {/* Class */}
                <div>
                  <span className="text-xs px-2.5 py-1 bg-indigo-50 text-indigo-700 rounded-full border border-indigo-100 font-medium">
                    {entry.class_name || '—'}
                  </span>
                </div>
